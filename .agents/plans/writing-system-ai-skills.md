...
frontmatter schemas. An agent can use this config to actively assist the writing process,
...
- Can help draft or suggest frontmatter values (categories, tags) based on title/content
